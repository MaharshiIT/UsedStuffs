    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["id"] == null)
            {
                ...
                if (txtDesc.Text.Length > 500)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "script1", "<script type='text/javascript'>document.getElementById('val').innerHTML='Description strength exceeds 500 chars!';</script>", false);
                    return;
                }
                ...
                p._User_ID = Convert.ToInt16(Session["User_id"]);
                if (rbS.Checked)
                    p._Status = "Sold";
                else
                    p._Status = "Unsold";
                ...
                if (i != 0)
                {
                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "script1", "<script type='text/javascript'>document.getElementById('val').innerHTML='Product posted successfully...';</script>", false);
                    if (fn != "noimg.jpg")
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "script1", "<script type='text/javascript'>document.getElementById('val').innerHTML='Problem in connection';</script>", false);
