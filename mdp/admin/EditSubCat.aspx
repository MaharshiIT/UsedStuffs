<%@ Page Title="" Language="C#" MasterPageFile="~/mdp/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="EditSubCat.aspx.cs" Inherits="mdp_admin_EditSubCat" %>
...
<script type="text/javascript">
 ...
 <form id="frm" class="frm" runat="server">
  <asp:HiddenField ID="hidCount" runat="server" Value="" />
    ...
    <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("Sub_ID") %>' />
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Name" SortExpression="SubName">
    <ItemTemplate>
    <asp:Label ID="lblSName" runat="server" Text='<%#Eval("SubName") %>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:ImageButton ID="btnEdit" runat="server" ToolTip="Edit" ImageUrl="~/mdp/admin/images/user_edit.png" OnClick="btnClick" CommandArgument='<%#Eval("Sub_ID") %>' />
