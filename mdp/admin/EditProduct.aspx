<%@ Page Title="" Language="C#" MasterPageFile="~/mdp/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="EditProduct.aspx.cs" Inherits="mdp_admin_EditProduct" %>
...
<script type="text/javascript">
 ...
 <form id="frm" class="frm" runat="server">
  <asp:HiddenField ID="hidCount" runat="server" Value="" />
    ...
    <asp:DropDownList ID="drpSearch" OnSelectedIndexChanged="drpChange" AutoPostBack="true" CssClass="dropSearch" runat="server">
    <asp:ListItem>--Please select--</asp:ListItem>
    <asp:ListItem Value="Name">Name</asp:ListItem>
    <asp:ListItem Value="Model">Model</asp:ListItem>
    <asp:ListItem Value="CName">Category</asp:ListItem>
    <asp:ListItem Value="SubName">Subcategory</asp:ListItem>
    <asp:ListItem Value="UName">User</asp:ListItem>
    </asp:DropDownList> 
    <asp:TextBox ID="txtSearch" runat="server" CssClass="search_input"></asp:TextBox>
    <asp:DropDownList ID="drpCat" Visible="false" CssClass="dropSearch" runat="server"></asp:DropDownList>
    <asp:DropDownList ID="drpSub" Visible="false" CssClass="dropSearch" runat="server"></asp:DropDownList>
    ...
    <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("Prod_ID") %>' />
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Image">
    <ItemTemplate>
    <asp:Image ID="imgName" runat="server" Width="50" Height="50" ImageUrl='<%#"~/Photos/"+Eval("Photo")%>'/>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:Label ID="lblPos" runat="server" Text='<%#Eval("Model") %>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <asp:Label ID="lblPrice" runat="server" Text='<%#Eval("Price") %>'></asp:Label>
     ...
     <asp:TemplateField HeaderText="Owner" SortExpression="UName">
    <ItemTemplate>
    <asp:Label ID="lblOwn" runat="server" Text='<%#Eval("UName") %>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Edit">
    <ItemTemplate>
    <asp:ImageButton ID="btnEdit" runat="server" ToolTip="Edit" ImageUrl="~/mdp/admin/images/user_edit.png" OnClick="btnClick" CommandArgument='<%#Eval("Prod_ID") %>' />
