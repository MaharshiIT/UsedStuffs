<%@ Page Title="SMS :: Admin Panel :: Admin Home" Language="C#" MasterPageFile="~/mdp/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminHome.aspx.cs" Inherits="admin_AdminHome" %>
...
<script type="text/javascript">
 ...
 <form id="frm" class="frm" runat="server">
  <asp:HiddenField ID="hidCount" runat="server" Value="" />
    ...
    <asp:ImageButton ID="btnSearch" runat="server" ToolTip="Search" ImageUrl="~/mdp/admin/images/search.png" OnClick="Search1" CssClass="search_submit" /><asp:UpdateProgress ID="Prog" runat="server" AssociatedUpdatePanelID="up1"><ProgressTemplate><img src="images/loader.gif" alt="" /></ProgressTemplate></asp:UpdateProgress></div>
    ...
    <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("User_ID") %>' />
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:ImageButton ID="btnEdit" runat="server" ToolTip="Edit" ImageUrl="~/mdp/admin/images/user_edit.png" OnClick="btnClick" CommandArgument='<%#Eval("User_ID") %>' />
