<%@ Page Title="" Language="C#" MasterPageFile="~/mdp/admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Log.aspx.cs" Inherits="mdp_admin_Log" %>
...
<script type="text/javascript">
 ...
 <form id="frm" class="frm" runat="server">
  <asp:HiddenField ID="hidCount" runat="server" Value="" />
    ...
    <asp:GridView ID="gridAdmin" runat="server" AllowPaging="true" OnPageIndexChanging="pageChange" AutoGenerateColumns="false" CssClass="rounded-corner">
    <Columns>
    ...
    <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("Log_ID") %>' />
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="IP">
    <ItemTemplate>
    <asp:Label ID="lblName" runat="server" Text='<%#Eval("IP") %>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    ...
    <ItemTemplate>
    <asp:Label ID="lblBrow" runat="server" Text='<%#Eval("Browser") %>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
    </Columns>
